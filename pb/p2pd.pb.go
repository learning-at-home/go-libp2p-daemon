...
const (
	...
	Request_BANDWIDTH_METRICS       Request_Type = 11
)
...
func (PSRequest_Type) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_7333f0e9b622f7df, []int{17, 0}
}
...
type Request struct {
	...
	Bwr                  *BandwidthMetricsRequest    `protobuf:"bytes,10,opt,name=bwr" json:"bwr,omitempty"`
...
func (m *Request) GetBwr() *BandwidthMetricsRequest {
	if m != nil {
		return m.Bwr
	}
	return nil
...
type Response struct {
	...
	Bwr                  *BandwidthMetricsResponse `protobuf:"bytes,8,opt,name=bwr" json:"bwr,omitempty"`
	XXX_NoUnkeyedLiteral struct{}                  `json:"-"`
	XXX_unrecognized     []byte                    `json:"-"`
	XXX_sizecache        int32                     `json:"-"`
}
...
func (m *Response) GetBwr() *BandwidthMetricsResponse {
	if m != nil {
		return m.Bwr
	}
	return nil
...
func (m *BandwidthResponse) Reset()         { *m = BandwidthResponse{} }
func (m *BandwidthResponse) String() string { return proto.CompactTextString(m) }
...
func (m *BandwidthResponse) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *BandwidthResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_BandwidthResponse.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *BandwidthResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_BandwidthResponse.Merge(m, src)
}
func (m *BandwidthResponse) XXX_Size() int {
	return m.Size()
}
func (m *BandwidthResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_BandwidthResponse.DiscardUnknown(m)
}

var xxx_messageInfo_BandwidthResponse proto.InternalMessageInfo

func (m *BandwidthResponse) GetValue() int64 {
...
type PeerInfo struct {
	Id                   []byte   `protobuf:"bytes,1,req,name=id" json:"id,omitempty"`
	Addrs                [][]byte `protobuf:"bytes,2,rep,name=addrs" json:"addrs,omitempty"`
	Ratein               *float64 `protobuf:"fixed64,3,opt,name=ratein" json:"ratein,omitempty"`
	Rateout              *float64 `protobuf:"fixed64,4,opt,name=rateout" json:"rateout,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (m *PeerInfo) GetRatein() float64 {
	if m != nil && m.Ratein != nil {
		return *m.Ratein
	}
	return 0
}

func (m *PeerInfo) GetRateout() float64 {
	if m != nil && m.Rateout != nil {
		return *m.Rateout
	}
	return 0
}
...
func (*Cancel) Descriptor() ([]byte, []int) {
	return fileDescriptor_7333f0e9b622f7df, []int{25}
}
...
type BandwidthMetricsRequest struct {
	ForSelf              *bool    `protobuf:"varint,1,opt,name=forSelf,def=0" json:"forSelf,omitempty"`
	ForAllPeers          *bool    `protobuf:"varint,2,opt,name=forAllPeers,def=0" json:"forAllPeers,omitempty"`
	Ids                  [][]byte `protobuf:"bytes,3,rep,name=ids" json:"ids,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}

func (m *BandwidthMetricsRequest) Reset()         { *m = BandwidthMetricsRequest{} }
func (m *BandwidthMetricsRequest) String() string { return proto.CompactTextString(m) }
func (*BandwidthMetricsRequest) ProtoMessage()    {}
func (*BandwidthMetricsRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_7333f0e9b622f7df, []int{26}
}
func (m *BandwidthMetricsRequest) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *BandwidthMetricsRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_BandwidthMetricsRequest.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *BandwidthMetricsRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_BandwidthMetricsRequest.Merge(m, src)
}
func (m *BandwidthMetricsRequest) XXX_Size() int {
	return m.Size()
}
func (m *BandwidthMetricsRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_BandwidthMetricsRequest.DiscardUnknown(m)
}

var xxx_messageInfo_BandwidthMetricsRequest proto.InternalMessageInfo

const Default_BandwidthMetricsRequest_ForSelf bool = false
const Default_BandwidthMetricsRequest_ForAllPeers bool = false

func (m *BandwidthMetricsRequest) GetForSelf() bool {
	if m != nil && m.ForSelf != nil {
		return *m.ForSelf
	}
	return Default_BandwidthMetricsRequest_ForSelf
}

func (m *BandwidthMetricsRequest) GetForAllPeers() bool {
	if m != nil && m.ForAllPeers != nil {
		return *m.ForAllPeers
	}
	return Default_BandwidthMetricsRequest_ForAllPeers
}

func (m *BandwidthMetricsRequest) GetIds() [][]byte {
	if m != nil {
		return m.Ids
	}
	return nil
...
type BandwidthMetricsResponse struct {
	SelfRateIn           *float64    `protobuf:"fixed64,1,opt,name=selfRateIn" json:"selfRateIn,omitempty"`
	SelfRateOut          *float64    `protobuf:"fixed64,2,opt,name=selfRateOut" json:"selfRateOut,omitempty"`
...
func (m *BandwidthMetricsResponse) Reset()         { *m = BandwidthMetricsResponse{} }
func (m *BandwidthMetricsResponse) String() string { return proto.CompactTextString(m) }
func (*BandwidthMetricsResponse) ProtoMessage()    {}
func (*BandwidthMetricsResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_7333f0e9b622f7df, []int{27}
}
func (m *BandwidthMetricsResponse) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *BandwidthMetricsResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_BandwidthMetricsResponse.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *BandwidthMetricsResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_BandwidthMetricsResponse.Merge(m, src)
}
func (m *BandwidthMetricsResponse) XXX_Size() int {
	return m.Size()
}
func (m *BandwidthMetricsResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_BandwidthMetricsResponse.DiscardUnknown(m)
}

var xxx_messageInfo_BandwidthMetricsResponse proto.InternalMessageInfo

func (m *BandwidthMetricsResponse) GetSelfRateIn() float64 {
	if m != nil && m.SelfRateIn != nil {
		return *m.SelfRateIn
	}
	return 0
}

func (m *BandwidthMetricsResponse) GetSelfRateOut() float64 {
	if m != nil && m.SelfRateOut != nil {
		return *m.SelfRateOut
	}
	return 0
}

func (m *BandwidthMetricsResponse) GetPeers() []*PeerInfo {
	if m != nil {
		return m.Peers
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*BandwidthResponse)(nil), "p2pd.pb.BandwidthResponse")
	...
	proto.RegisterType((*BandwidthMetricsRequest)(nil), "p2pd.pb.BandwidthMetricsRequest")
	proto.RegisterType((*BandwidthMetricsResponse)(nil), "p2pd.pb.BandwidthMetricsResponse")
}
...
var fileDescriptor_7333f0e9b622f7df = []byte{
	...
	,
}
...
func (m *Request) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.Bwr != nil {
		{
			size, err := m.Bwr.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *BandwidthResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *BandwidthResponse) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *BandwidthResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	...
	if m.Value == nil {
		...
		i = encodeVarintP2Pd(dAtA, i, uint64(*m.Value))
		i--
		dAtA[i] = 0x8
	}
	return len(dAtA) - i, nil
...
func (m *BandwidthMetricsRequest) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *BandwidthMetricsRequest) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *BandwidthMetricsRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	...
	if len(m.Ids) > 0 {
		for iNdEx := len(m.Ids) - 1; iNdEx >= 0; iNdEx-- {
			...
			i = encodeVarintP2Pd(dAtA, i, uint64(len(m.Ids[iNdEx])))
			i--
			dAtA[i] = 0x1a
		}
	}
	if m.ForAllPeers != nil {
		i--
		if *m.ForAllPeers {
			dAtA[i] = 1
		} else {
...
func (m *BandwidthMetricsResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *BandwidthMetricsResponse) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *BandwidthMetricsResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	...
	if m.SelfRateOut != nil {
		i -= 8
		encoding_binary.LittleEndian.PutUint64(dAtA[i:], uint64(math.Float64bits(float64(*m.SelfRateOut))))
		i--
		dAtA[i] = 0x11
	}
	if m.SelfRateIn != nil {
		i -= 8
		encoding_binary.LittleEndian.PutUint64(dAtA[i:], uint64(math.Float64bits(float64(*m.SelfRateIn))))
		i--
		dAtA[i] = 0x9
	}
	return len(dAtA) - i, nil
...
func (m *BandwidthResponse) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *BandwidthMetricsRequest) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *BandwidthMetricsResponse) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *Request) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 10:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field Bwr", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.Bwr == nil {
				m.Bwr = &BandwidthMetricsRequest{}
			}
			if err := m.Bwr.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *Response) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 8:
			...
			if m.Bwr == nil {
				m.Bwr = &BandwidthMetricsResponse{}
			}
			if err := m.Bwr.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
...
func (m *BandwidthResponse) Unmarshal(dAtA []byte) error {
	var hasFields [1]uint64
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: BandwidthResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: BandwidthResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
...
func (m *BandwidthMetricsRequest) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: BandwidthMetricsRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: BandwidthMetricsRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field ForSelf", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
		...
		case 2:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field ForAllPeers", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
...
func (m *BandwidthMetricsResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: BandwidthMetricsResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: BandwidthMetricsResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 1 {
				return fmt.Errorf("proto: wrong wireType = %d for field SelfRateIn", wireType)
			}
			var v uint64
			if (iNdEx + 8) > l {
				return io.ErrUnexpectedEOF
		...
		case 2:
			if wireType != 1 {
				return fmt.Errorf("proto: wrong wireType = %d for field SelfRateOut", wireType)
			}
			var v uint64
			if (iNdEx + 8) > l {
				return io.ErrUnexpectedEOF
